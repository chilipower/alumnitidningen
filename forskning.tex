...
kring \textit{kinaser}, med fokus på deras dynamik. Det är bland annat
dynamiken vid uppveckning, ligandbindning och hastigheter som studeras,
vilket är betydande för proteiners funktion.

För att studera dynamiken hos kinaser tillämpas i huvudsak \textit{NMR},
...
\image{img/forskning_protein.png}{Strukturen för proteinet EphB2 som
  Patriks forskningsgrupp undersöker i ett av sina projekt vid LiU.}

I ett av projekten arbetar gruppen med kinaset \textit{EphB2}. Proteinet är
...
Det andra projektet fokuserar på \textit{malaria} som är en allvarlig och i
många fall dödlig sjukdom som tar livet av ungefär en halv miljon människor
om året; mestadels barn. Sjukdomen orsakas av parasiter av släktet \textit
...
kallat \textit{CDPK3} som förekommer hos malariaparasiten. Det är dessa kinaser
...
formen av kinasddomänen \textit{dimerer}, vilket kan ha stor betydelse för hur
